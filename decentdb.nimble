...
task test, "Run Nim + Python unit tests":
  ...
  exec "nim c -r tests/nim/test_wal_extra.nim"
  exec "nim c -r tests/nim/test_sql_exec.nim"
  exec "nim c -r tests/nim/test_binder.nim"
  exec "nim c -r tests/nim/test_sql_parser.nim"
  exec "nim c -r tests/nim/test_catalog.nim"
  exec "nim c -r tests/nim/test_engine.nim"

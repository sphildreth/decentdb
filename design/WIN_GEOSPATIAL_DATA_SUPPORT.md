...
**Related shipped foundation:** Native geospatial types and spatial indexes in [`../docs/user-guide/data-types.md`](../docs/user-guide/data-types.md) and [`../docs/user-guide/indexes.md`](../docs/user-guide/indexes.md)  
...
`design/FUTURE_WINS.md` tracks only advanced follow-on spatial work as future
roadmap scope. The shipped geospatial foundation is documented in the user
guide.

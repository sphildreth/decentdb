...
|---:|---|---|---|---|---|
| 1 | vNext | TODO | Core read/query engine performance | [`WIN_PERFORMANCE_IMPROVEMENTS_01.md`](WIN_PERFORMANCE_IMPROVEMENTS_01.md); ADR 0112, 0143-0145, 0184, 0190-0194 | Read performance is Priority #2 and the active evidence still points at generic executor materialization, view expansion, and structural planning as the next credibility gap |

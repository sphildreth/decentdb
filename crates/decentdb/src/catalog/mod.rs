...
pub(crate) use schema::{
    ...
    ForeignKeyConstraint, IndexColumn, IndexKind, IndexSchema, IndexStats, SchemaInfo,
    SpatialDimensions, SpatialSubtype, SpatialTypeInfo, TableSchema, TableStats, TriggerEvent,
